...
const Stats = ({mode , unIndex , windy , clouds , stats , sunrise ,sunset}) => {
  return (
    <div>
      <div className="container w-[70%] m-auto mt-10 md:flex justify-between md:w-[90%] items-center ">
          <div className="content1 md:w-[40%]">
               <div className={!mode ? "flex justify-between border border-[#D3D9E8] bg-[#fff] text-[#020419] p-5 rounded-md md:w-full" : "humi flex justify-between border border-[#D3D9E8] bg-[#fff] text-[#020419] p-5 rounded-md md:w-full"}>
                      <div className="humi-left w-[50%] border-r border-r-[#D3D9E8]">
                        <div className="wrapper flex gap-3 items-center ">
                          ...
                          <div className="text">
                            <h1>Humidity</h1>
                            <span className='font-bold text-[12px]'>{stats}%</span>
                          </div>
                        </div>
                        <div className="wrapper mt-5 flex gap-3 items-center">
                          ...
                          <div className="text">
                            <h1>UV Index</h1>
                            <span className='font-bold text-[12px]'>{unIndex}</span>
                          </div>
                        </div>
                      ...
                      <div className="humi-right">
                        <div className="wrapper flex gap-3 items-center ">
                          ...
                          <div className="text">
                            <h1>Sunrise</h1>
                            <span className='font-bold text-[12px]'>{sunrise}</span>
                          </div>
                        </div>
                        <div className="wrapper mt-5 flex gap-3 items-center">
                            <div className="icon">
                          ...
                          <div className="text">
                            <h1>Sunset</h1>
                            <span className='font-bold text-[12px]'>{sunset}</span>
                          </div>
                      </div>
                      </div>
               </div>
               <div className={!mode ? "rainfall flex justify-between p-5 bg-[#D3D9E8] mt-5 rounded-md" : "rainfallDark flex justify-between p-5 bg-[#5091BA] text-[#020419] mt-5 rounded-md"}>
                   <div className="text">
           ...
           <div className="data mt-5 mb-10 md:w-[50%]">
               <div className={!mode ? "stats border border-[#D3D9E8] bg-[#fff] text-[#020419] p-5 rounded-md" : "stats border border-[#D3D9E8] bg-[#fff] text-[#020419] p-5 rounded-md "}>
                  ...
                  <div className="container flex mt-5 justify-between gap-2  items-center">
                    ...
                    <FiSun size={20}/>
                    <h1 className='font-bold mt-2'>{unIndex}</h1>
                   </div> 
                    <div className="mon flex flex-col items-center   ">
                    <h1 className="text-[12px] mb-2">01 am</h1>
                    <h1 className='font-semibold py-2 text-[14px]'>Windy</h1>
                    <FiWind size={20}/>
                    <h1 className='font-bold mt-2'>{windy}°</h1>
                   ...
                   <CgCodeClimate size={20}/>
                    <h1 className='font-bold mt-2'>{clouds}</h1>
                   </div> 
